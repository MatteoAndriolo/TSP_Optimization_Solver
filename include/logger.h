...
// TODO make such that verbosity regulates output in terminal
typedef enum {
    ERROR,
    WARNING,
    CRITICAL,
...
/**
 * Logs a message to the log file, including the name of the file and function where the message is logged.
 * 
 * @param format a printf-style format string for the log message
 * @param ... variable arguments corresponding to the format string
*/
