...
void genetic_setup(GENETIC_SETUP *setup, int ngenerations, int population_size,
                   int windows_size, int grasp_n_probabilities,
                   double *grasp_probabilities);

void genetic_population(GENETIC_POPULATION *population, GENETIC_SETUP *setup);

void genetic_individual(GENETIC_INDIVIDUAL *individual, int nnodes, int *path,
                        double tour_length);
